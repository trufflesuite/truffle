...
var templates = {
  test: {
    filenameJs: path.join(__dirname, "../", "templates", "example.js"),
    filenameSol: path.join(__dirname, "../", "templates", "TestExample.sol")
  },
  contract: {
...
var Create = {
  ...
  test: function(directory, name, callback) {
    ...
    var from = templates.test.filenameJs;
    ...
    file.duplicate(from, to, function(err) {
      ...
      file.replace(to, templates.contract.name, name, function() {
        file.replace(to, templates.contract.variable, underscored, function() {
          from = templates.test.filenameSol;
          to = path.join(directory, "Test" + name + ".sol");
