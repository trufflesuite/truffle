...
import {CheckCircleIcon, ExclamationCircleIcon, ExternalLinkIcon} from '@heroicons/react/solid';
...
export default function TransactionPopup({
  ...
  return (
    <div className="flex flex-row w-full flex-nowrap">
      <div className="pr-4">
        {success ? <CheckCircleIcon  className="h-10 w-10 text-truffle-blue"/> :
          <ExclamationCircleIcon className="h-10 w-10 text-truffle-red"/>}
      </div>
