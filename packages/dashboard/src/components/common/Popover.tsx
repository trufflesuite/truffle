    ...
    <Popover>
      ...
      <Popover.Panel className="absolute z-10 bottom-14 right-2 mb-2">
        <div className="bg-truffle-light border-2 mb-4 block z-50 font-normal leading-normal text-lg max-w-xs no-underline break-words rounded-lg">
          ...
          <div className="bg-truffle-light text-truffle-brown m-2">You can help us improve Truffle by allowing us to track how you use our tools.Would you like to allow tracking?You can always return to this menu if you change your mind. View the Truffle Analytics Policy <a href="https://trufflesuite.com/analytics/">here.</a>
            <AnalyticsToggle />
          </div>
        </div>
