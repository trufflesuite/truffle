...
/// / <reference path="../truffle/typings/event-hooks-webpack-plugin.d.ts" />
import * as webpack from "webpack";
import type { WebpackConfiguration as Configuration } from "webpack-dev-server";
...
const frontendConfig: Configuration = {
  ...
  entry: path.resolve(__dirname, "frontend-build", "index.js"),
  target: "web",
  output: {
    filename: "index.js",
