...
import { Pointer, Request } from "@truffle/codec/types";
import * as Evm from "@truffle/codec/evm";
import { DecodingError } from "@truffle/codec/decode/errors";

export default function* decodeMemory(dataType: Types.Type, pointer: Pointer.MemoryPointer, info: Evm.Types.EvmInfo): Generator<Request.DecoderRequest, Values.Result, Uint8Array> {
...
export function* decodeMemoryReferenceByAddress(dataType: Types.ReferenceType, pointer: Pointer.DataPointer, info: Evm.Types.EvmInfo): Generator<Request.DecoderRequest, Values.Result, Uint8Array> {
  const { state } = info;
