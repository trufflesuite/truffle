...
export default function* decodeAbi(dataType: Types.Type, pointer: Pointer.AbiDataPointer, info: Evm.Types.EvmInfo, options: Options.DecoderOptions = {}): Generator<Request.DecoderRequest, Values.Result, Uint8Array> {
...
export function* decodeAbiReferenceByAddress(dataType: Types.ReferenceType | Types.TupleType, pointer: Pointer.DataPointer, info: Evm.Types.EvmInfo, options: Options.DecoderOptions = {}): Generator<Request.DecoderRequest, Values.Result, Uint8Array> {
...
export function* decodeAbiReferenceStatic(dataType: Types.ReferenceType | Types.TupleType, pointer: Pointer.AbiDataPointer, info: Evm.Types.EvmInfo, options: Options.DecoderOptions = {}): Generator<Request.DecoderRequest, Values.Result, Uint8Array> {
  debug("static");
  debug("pointer %o", pointer);
...
function* decodeAbiStructByPosition(dataType: Types.StructType, location: AbiLocation, startPosition: number, info: Evm.Types.EvmInfo, options: Options.DecoderOptions = {}): Generator<Request.DecoderRequest, Values.StructResult, Uint8Array> {
...
//note that this function takes the start position as a *number*; it does not take a pointer
function* decodeAbiTupleByPosition(dataType: Types.TupleType, location: AbiLocation, startPosition: number, info: Evm.Types.EvmInfo, options: Options.DecoderOptions = {}): Generator<Request.DecoderRequest, Values.TupleResult, Uint8Array> {
