...
import { Pointer, Storage as StorageTypes, Request } from "@truffle/codec/types";
...
export default function* decodeStorage(dataType: Types.Type, pointer: Pointer.StoragePointer, info: Evm.Types.EvmInfo): Generator<Request.DecoderRequest, Values.Result, Uint8Array> {
...
export function* decodeStorageReferenceByAddress(dataType: Types.ReferenceType, pointer: Pointer.DataPointer, info: Evm.Types.EvmInfo): Generator<Request.DecoderRequest, Values.Result, Uint8Array> {
...
export function* decodeStorageReference(dataType: Types.ReferenceType, pointer: Pointer.StoragePointer, info: Evm.Types.EvmInfo): Generator<Request.DecoderRequest, Values.Result, Uint8Array> {
  var data;
  var length;
