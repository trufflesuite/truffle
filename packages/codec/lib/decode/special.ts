...
export function* decodeMagic(dataType: Types.MagicType, pointer: Pointer.SpecialPointer, info: Evm.EvmInfo): Generator<Request.DecoderRequest, Values.MagicResult, Uint8Array> {
