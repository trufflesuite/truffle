...
export default function* decodeTopic(dataType: Types.Type, pointer: Pointer.EventTopicPointer, info: Evm.Types.EvmInfo, options: Options.DecoderOptions = {}): Generator<Request.DecoderRequest, Values.Result, Uint8Array> {
