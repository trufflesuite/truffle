...
export namespace TypeUtils {
  export function isContractDefinedType(
    anyType: Types.Type
  ): anyType is Types.ContractDefinedType {
  ...
  export function isUserDefinedType(
    anyType: Types.Type
  ): anyType is Types.UserDefinedType {
  ...
  export function isReferenceType(
    anyType: Types.Type
  ): anyType is Types.ReferenceType {
  ...
  export function fullType(
    ...
    if (
      TypeUtils.isReferenceType(basicType) &&
      basicType.location !== undefined
    ) {
  ...
  export function specifyLocation(
    dataType: Types.Type,
    location: Ast.Location | undefined
  ): Types.Type {
  ...
  export function typeStringWithoutLocation(dataType: Types.Type): string {
    switch (dataType.typeClass) {
      ...
      case "function":
        ...
        let outputList = dataType.outputParameterTypes
          .map(typeString)
          .join(",");
