        ...
        switch (this.result.type.typeClass) {
          ...
          case "int":
            return options.stylize(
              (<Values.UintValue | Values.IntValue>(
                this.result
              )).value.asBN.toString(),
              "number"
            );
          ...
          case "bool":
            return util.inspect(
              (<Values.BoolValue>this.result).value.asBoolean,
              options
            );
          case "bytes":
          ...
          case "address":
            return options.stylize(
              (<Values.AddressValue>this.result).value.asAddress,
              "number"
            );
          case "string": {
          ...
          case "magic":
            return util.inspect(
              Object.assign(
                {},
                ...Object.entries((<Values.MagicValue>this.result).value).map(
