...
describe
  .only("migrate", function () {
    ...
    it.only("links libraries in initial project, and runs all migrations", async function () {
      this.timeout(10000);
    ...
    it.only("should migrate secondary network without altering primary network", async function () {
      this.timeout(10000);
