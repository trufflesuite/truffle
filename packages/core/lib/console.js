...
class Console extends EventEmitter {
  constructor(tasks, options) {
    ...
    // TODO BGC Not needed with tezos, perhaps set up with method from interfaceAdapter
  ...
  provision() {
    ...
    const abstractions = jsonBlobs.map(json => {
      ...
      // TODO BGC Implement provision for tezos so that this is no longer needed
