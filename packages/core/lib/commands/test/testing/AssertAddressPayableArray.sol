...
library AssertAddressPayableArray {
    ...
    */
    function equal(address payable[] memory arrA, address payable[] memory arrB, string memory message) public returns (bool result) {
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function notEqual(address payable[] memory arrA, address payable[] memory arrB, string memory message) public returns (bool result) {
        result = arrA.length == arrB.length;
        if (result) {
            for (uint i = 0; i < arrA.length; i++) {
                if (arrA[i] != arrB[i]) {
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function lengthEqual(address payable[] memory arr, uint length, string memory message) public returns (bool result) {
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function lengthNotEqual(address payable[] memory arr, uint length, string memory message) public returns (bool result) {
        uint arrLength = arr.length;
