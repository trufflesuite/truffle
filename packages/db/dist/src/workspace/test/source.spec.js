...
describe("Source", () => {
  ...
  beforeEach(() =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      addSourceResult = yield wsClient.execute(
  ...
  test("can be queried", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const getSourceResult = yield wsClient.execute(
        source_graphql_1.GetSource,
        {
          id: expectedId
        }
      );
  ...
  test("can retrieve all sources", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const getAllSourcesResult = yield wsClient.execute(
        source_graphql_1.GetAllSources,
        {}
      );
