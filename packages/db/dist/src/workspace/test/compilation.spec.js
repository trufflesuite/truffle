...
describe("Compilation", () => {
  ...
  beforeEach(() =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      addCompilationResult = yield wsClient.execute(
  ...
  test("can be queried", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      const getCompilationResult = yield wsClient.execute(
        compilation_graphql_1.GetCompilation,
        {
          id: expectedId
        }
      );
  ...
  test("can retrieve all compilations", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const allCompilationsResult = yield wsClient.execute(
        compilation_graphql_1.GetAllCompilations,
        {}
      );
