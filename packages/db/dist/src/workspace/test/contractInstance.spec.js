...
describe("Contract Instance", () => {
      ...
      variables = [
        {
          ...
          creation: {
            transactionHash:
              utils_1.Migrations.networks["5777"].transactionHash,
            constructor: {
              createBytecode: {
                bytecode: {
  ...
  test("can be added", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const addContractInstancesResult = yield wsClient.execute(
        contractInstance_graphql_1.AddContractInstances,
      ...
      expect(address).toEqual(
        Object.values(utils_1.Migrations.networks)[0]["address"]
      );
  ...
  test("can be queried", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const getContractInstanceResult = yield wsClient.execute(
        contractInstance_graphql_1.GetContractInstance,
        { id: expectedId }
      );
  ...
  test("can retrieve all contractInstances", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const getAllContractInstancesResult = yield wsClient.execute(
        contractInstance_graphql_1.GetAllContractInstances,
        {}
      );
