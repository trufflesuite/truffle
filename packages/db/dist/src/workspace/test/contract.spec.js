...
describe("Contract", () => {
    ...
    test("can be queried via compilation", () => __awaiter(void 0, void 0, void 0, function* () {
        expectedId = utils_1.generateId({
            name: utils_1.Migrations.contractName,
            abi: { json: JSON.stringify(utils_1.Migrations.abi) },
            processedSource: { index: 0 },
        ...
        const result = yield wsClient.execute(compilation_graphql_1.GetCompilationWithContracts, {
            id: compilationId
        });
