...
exports.fixturesDirectory = path_1.default.join(__dirname, // db/src/db/test
"..", // db/src/db
"..", // db/src/
"..", // db/
"test", "fixtures");
...
class WorkspaceClient {
    ...
    execute(request, variables = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield graphql.execute(workspace_1.schema, request, null, // root object, managed by workspace
