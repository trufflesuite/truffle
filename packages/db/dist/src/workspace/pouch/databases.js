...
class Databases {
    ...
    initialize() {
        return __awaiter(this, void 0, void 0, function* () {
            yield Promise.all(Object.entries(this.definitions).map(([collectionName, definition]) => this.initializeCollection(collectionName, definition)));
        });
    }
    ...
    add(collectionName, input) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.ready;
            const resources = yield Promise.all(input[collectionName].map((resourceInput) => __awaiter(this, void 0, void 0, function* () {
                ...
                const resourceAdded = yield this.collections[collectionName].put(Object.assign(Object.assign({}, resourceInput), { _id: id }));
    ...
    update(collectionName, input) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resources = yield Promise.all(input[collectionName].map((resourceInput) => __awaiter(this, void 0, void 0, function* () {
                ...
                const resourceAdded = yield this.collections[collectionName].put(Object.assign(Object.assign({}, resourceInput), { _rev, _id: id }));
                return Object.assign(Object.assign({}, resourceInput), { id });
            })));
            return {
                [collectionName]: resources
    ...
    generateId(collectionName, input) {
        ...
        return helpers_1.generateId(idFields.reduce((obj, field) => (Object.assign(Object.assign({}, obj), { [field]: input[field] })), {}));
    }
}
