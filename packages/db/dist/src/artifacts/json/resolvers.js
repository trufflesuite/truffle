    ...
    Query: {
        contract: {
            resolve(_, { name, networkId }, context) {
                ...
                const linkedBytecodeCall = shims_1.shimBytecode(artifact.deployedBytecode);
                const result = Object.assign(Object.assign({}, artifact), { abi: {
                ...
                if (networkId) {
                    return result.networks[networkId]
                        ? Object.assign(Object.assign({}, result), { networks: {
