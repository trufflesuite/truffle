...
function processSchema(name, schema) {
  const definitions = [
    ...Object.entries(schema.definitions).map(([id, definition]) =>
      Object.assign(Object.assign({}, definition), { $id: id })
    )
  ];
  return [
    ...definitions,
    Object.assign(Object.assign({}, schema), { $id: name })
  ];
}
const translations = [
  // fix cross-schema references
  _a => {
    var { contractObject } = _a,
      schemas = __rest(_a, ["contractObject"]);
    return Object.assign(Object.assign({}, schemas), {
      contractObject: Object.assign(Object.assign({}, contractObject), {
        properties: Object.assign(
          Object.assign({}, contractObject.properties),
          {
            networks: Object.assign(
              Object.assign({}, contractObject.properties.networks),
              {
  ...
  _a => {
    var { abi } = _a,
      schemas = __rest(_a, ["abi"]);
    return Object.assign(Object.assign({}, schemas), {
      abi: Object.assign(Object.assign({}, abi), {
        definitions: Object.assign(Object.assign({}, abi.definitions), {
          Type: {
            type: "string"
          }
        })
    ...
    return Object.assign(Object.assign({}, schemas), {
      abi: Object.assign(Object.assign({}, abi), {
        definitions: Object.assign(
          Object.assign(Object.assign({}, abi.definitions), {
          ...
          Object.assign(
            ...
            ...[
              ...
              .map(([typeName, itemType]) => ({
                [typeName]: Object.assign(Object.assign({}, itemType), {
                  properties: Object.assign(
                    Object.assign({}, itemType.properties),
                    {
...
function processSchemas(schemas) {
  const { abi, networkObject, contractObject } = translations.reduce(
    (schemas, translate) => translate(schemas),
    schemas
  );
  return {
    ...
    fields: {
      ...
      contractNames: {
        type: new graphql_1.GraphQLNonNull(
          new graphql_1.GraphQLList(types["Name"])
        )
      }
    }
  })
...
exports.schema = graphql_tools_1.makeExecutableSchema({
  typeDefs: graphql_1.printSchema(
    convert({
      jsonSchema: [
        ...jsonSchemas.abi,
