...
describe("Artifacts queries", () => {
  it("lists artifact contract names", () =>
  ...
  it("retrieves contract correctly", () =>
    __awaiter(void 0, void 0, void 0, function* () {
  ...
  it("retrieves contract bytecodes correctly", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      expect(callBytecode).toEqual(
        shims_1.shimBytecode(Migrations.deployedBytecode)
      );
      expect(processedSource).toHaveProperty("source");
  ...
  it("retrieves contract information for an instance", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      expect(bytes).toEqual(
        shims_1.shimBytecode(Migrations.deployedBytecode).bytes
      );
      expect(linkReferences).toEqual(
        shims_1.shimBytecode(Migrations.deployedBytecode).linkReferences
      );
    }));
});
