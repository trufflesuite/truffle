...
exports.schema = utils_1.scopeSchemas({
    ...
    typeDefs: [
        ...
        graphql_tools_1.transformSchema(artifacts_1.abiSchema, [new graphql_tools_1.FilterRootFields(() => false)])
    ],
    resolvers: {
        Bytecode: {
            instructions: {
                fragment: "... on Bytecode { bytes sourceMap }",
                resolve: ({ bytes, sourceMap }) => bytecode_1.readInstructions(bytes, sourceMap)
            }
        },
        AbiItem: {
            __resolveType(obj) {
