...
exports.buildObjForSchema = schema => Object.entries(operationGetters)
...
exports.buildOpsObjectForName = (name, opsArray) => opsArray
...
exports.buildSchemaForName = (name, operationsArray) => operationsArray
    ...
    .reduce((a, b) => (Object.assign(Object.assign({}, a), b)), {}); // combine objects
exports.buildRootResolvers = schemaOperations => Object.entries(schemaOperations).reduce((accumulator, [name, operations]) => {
    return Object.assign(Object.assign({}, accumulator), Object.keys(operations)
        .map(operation => (Object.assign(Object.assign({}, (accumulator[operation] || {})), { [pascal_case_1.default(operation)]: {
            [name]: () => true
        } })))
        .reduce((a, b) => (Object.assign(Object.assign({}, a), b))));
}, {});
exports.buildResolverForSubschema = (schema, operationsArray) => operationsArray
    .map(([operation, typeDef]) => ({
    [typeDef.name]: Object.keys(operationGetters[operation](schema).getFields())
        .map(fieldName => ({
        [fieldName]: {
