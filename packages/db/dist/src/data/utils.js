...
function scopeSchemas(config) {
    ...
    const schemas = [
        ...Object.entries(schemaOperations).map(([name, operations]) => {
            ...
            return new graphql_1.GraphQLSchema(util_helpers_1.buildSchemaForName(name, operationsArray));
        }),
        ...(typeDefs || [])
    ];
    ...
    return graphql_tools_1.mergeSchemas({
        schemas,
        resolvers: Object.assign(Object.assign(Object.assign({}, rootResolvers), subschemaResolvers), resolvers)
    });
}
