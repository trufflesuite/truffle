...
Object.defineProperty(exports, "AddCompilations", {
  enumerable: true,
  get: function () {
    return add_graphql_1.AddCompilations;
  }
});
var get_graphql_1 = require("./get.graphql");
Object.defineProperty(exports, "GetCompilation", {
  enumerable: true,
  get: function () {
    return get_graphql_1.GetCompilation;
  }
});
const compilationSourceInputs = ({ compilation, sources }) =>
  compilation.sources.map(({ input: { sourcePath } }) => sources[sourcePath]);
const compilationProcessedSourceInputs = ({ compilation, sources }) =>
