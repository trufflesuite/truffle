...
Object.defineProperty(exports, "ArtifactsLoader", { enumerable: true, get: function () { return artifactsLoader_1.ArtifactsLoader; } });
...
const resolvers = {
    Mutation: {
        artifactsLoad: {
            resolve: (_, args, { artifactsDirectory, contractsDirectory, workingDirectory, db }, info) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.loaderSchema = graphql_tools_1.makeExecutableSchema({ typeDefs, resolvers });
