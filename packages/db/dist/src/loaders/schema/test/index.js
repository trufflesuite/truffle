...
jest.mock("@truffle/workflow-compile/new", () => ({
  compile: function (config, callback) {
    return require(path_1.default.join(
      __dirname,
...
const fixturesDirectory = path_1.default.join(
  __dirname,
  "compilationSources",
  "build",
  "contracts"
...
const compilationConfig = {
  ...
  contracts_build_directory: path_1.default.join(
    __dirname,
    "compilationSources",
    "build",
    "contracts"
  ),
  artifacts_directory: path_1.default.join(
    __dirname,
    "compilationSources",
    "build",
    "contracts"
...
const Migrations = require(path_1.default.join(
  fixturesDirectory,
  "Migrations.json"
));
const artifacts = [
...
describe("Compilation", () => {
  ...
  beforeAll(
    () =>
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield Promise.all(
          artifacts.map((contract, index) =>
            __awaiter(void 0, void 0, void 0, function* () {
              ...
              const shimBytecodeObject = shims_1.shimBytecode(
                contract["bytecode"]
              );
              const shimCallBytecodeObject = shims_1.shimBytecode(
              ...
              if (networksArray.length > 0) {
                const links =
                  networksArray[networksArray.length - 1][1]["links"];
                ...
                contractInstances.push({
                  address:
                    networksArray[networksArray.length - 1][1]["address"],
                  network: {
                    name: "development",
                    networkId: networkId,
                    historicBlock: historicBlock
                  ...
                  creation: {
                    transactionHash:
                      networksArray[networksArray.length - 1][1][
                        "transactionHash"
                      ],
                    constructor: {
                      createBytecode: {
        ...
        } = yield db.query(projects_1.AddProjects, {
          projects: [
            {
              directory: compilationConfig["working_directory"]
            }
        ...
        const contractNameRecord = yield db.query(
  ...
  it("loads compilations", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const compilationsQuery = yield Promise.all(
  ...
  it("loads contract sources", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      for (let index in sourceIds) {
        ...
        } = yield db.query(GetWorkspaceSource, sourceIds[index]);
  ...
  it("loads bytecodes", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      for (let index in bytecodeIds) {
        ...
        } = yield db.query(GetWorkspaceBytecode, bytecodeIds[index]);
  ...
  it("loads contracts", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      for (let index in artifacts) {
        ...
        } = yield db.query(GetWorkspaceContract, contractIds[index]);
        const artifactsCreateBytecode = shims_1.shimBytecode(
          artifacts[index].bytecode
        );
        expect(createBytecode.bytes).toEqual(artifactsCreateBytecode.bytes);
        const artifactsCallBytecode = shims_1.shimBytecode(
        ...
        } = yield db.query(projects_1.ResolveProjectName, {
          projectId,
          name: artifacts[index].contractName,
          type: "Contract"
        });
  ...
  it("loads networks", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      for (let index in migratedArtifacts) {
        ...
        } = yield db.query(GetWorkspaceNetwork, netIds[index]);
  ...
  it("loads contract instances", () =>
    __awaiter(void 0, void 0, void 0, function* () {
      for (const contractInstanceId of contractInstanceIds) {
        ...
        } = yield db.query(GetWorkspaceContractInstance, contractInstanceId);
