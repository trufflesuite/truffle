...
import { InterfaceAdapter, BlockType, TransactionCostReport, TransactionReceipt } from "../types";
...
export class TezosAdapter implements InterfaceAdapter {
  ...
  public async getBlock(blockNumber: BlockType): Promise<BlockHeaderResponse> {
  ...
  public async getTransactionCostReport(receipt: TransactionReceipt): Promise<TransactionCostReport> {
    ...
    return {
      timestamp: receipt.includedInBlock, // TODO BGC Should be timestamp, not block number
      from: "",
      balance: "", // TODO BGC Get sender address somehow
      gasUnit: "TEZ",
      gasPrice: "", // Gas price?
      gas: new BN(0), // Correct?
      valueUnit: "TEZ",
      value: receipt.amount,
      cost: new BN(0) // TODO gasPrice * gas + value
    };
    // const sender = ""; // TODO BGC Get sender address

    // return {
    //   timestamp: receipt.includedInBlock, // TODO BGC Should be timestamp, not block number
    //   from: sender,
    //   balance: await this.getBalance(sender), // TODO BGC Get sender address somehow
    //   gasUnit: "TEZ",
    //   gasPrice: "", // Gas price?
    //   gas: receipt.consumedGas, // Correct?
    //   valueUnit: "TEZ",
    //   value: receipt.amount,
    //   cost: new BN(0) // TODO gasPrice * gas + value
    // };
  ...
  public displayCost(value: BN): string {
