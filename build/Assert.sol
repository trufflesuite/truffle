...
library Assert {
    ...
    */
    function equal(bytes memory _a, bytes memory _b, string message) internal returns (bool) {
        bool returnBool = _bytesEqual(_a, _b);
    ...
    /*
        ...
        Assert that two tightly packed bytes arrays are not equal.
    ...
    */
    ...
    /*
        ...
        Assert that two tightly packed bytes arrays (one in storage and another in memory) are equal.
    ...
    */
    function equalStorage(bytes storage _a, bytes memory _b, string message) internal returns (bool) {
        bool returnBool = _bytesEqualStorage(_a, _b);
    ...
    /*
        ...
        Assert that two tightly packed bytes arrays (one in storage and another in memory) are not equal.
    ...
    */
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function _bytesEqual(bytes memory _a, bytes memory _b) internal pure returns (bool) {
    ...
    /*
        ...
        Returns:
            result (bool) - The result.
    */
    function _bytesEqualStorage(bytes storage _a, bytes memory _b) internal view returns (bool) {
        bool returnBool = true;
