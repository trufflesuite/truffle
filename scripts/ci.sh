...
if [ "$INTEGRATION" = true ]; then
  ...
  sudo apt update
  sudo apt install -y python3.6 python3.6-dev python3.6-venv solc=0.7.6 #please unpin once possible
  ...
  sudo add-apt-repository -y ppa:ethereum/ethereum
  sudo apt update
  sudo apt install -y jq python3.6 python3.6-dev python3.6-venv solc=0.7.6 #please unpin once possible
  wget https://bootstrap.pypa.io/get-pip.py
  sudo python3.6 get-pip.py
  sudo pip3 install vyper
